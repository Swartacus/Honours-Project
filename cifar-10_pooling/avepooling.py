...
avepooling.py
Author: Adam Swart
Creates CNNs that use average pooling for subsampling
'''
...
def cnn_elu(lmdb, batch_size, mean):
    ...
    n.pool1 = L.Pooling(n.drop1, kernel_size=2, stride=2, pool=P.Pooling.AVE)
    # second stack
    ...
    n.pool2 = L.Pooling(n.drop2, kernel_size=2, stride=2, pool=P.Pooling.AVE)
    # third stack
    ...
    n.pool3 = L.Pooling(n.drop3, kernel_size=2, stride=2, pool=P.Pooling.AVE)
    # fourth stack
    ...
    n.pool4 = L.Pooling(n.drop4, kernel_size=2, stride=2, pool=P.Pooling.AVE)
    # fifth stack
    ...
    n.drop5 = L.Dropout(n.elu9, dropout_ratio=0.4)
    n.pool5 = L.Pooling(n.drop5, kernel_size=2, stride=2, pool=P.Pooling.AVE)
    # sixth stack
    ...
    n.pool6 = L.Pooling(n.drop6, kernel_size=2, stride=2, pool=P.Pooling.AVE)
    # seventh stack
    ...
    n.pool7 = L.Pooling(n.drop7, kernel_size=2, stride=2, pool=P.Pooling.AVE)
...
def cnn_relu(lmdb, batch_size, mean):
    ...
    n.pool2 = L.Pooling(n.conv3, kernel_size=2, stride=2, pool=P.Pooling.AVE)
    ...
    n.pool3 = L.Pooling(n.conv5, kernel_size=2, stride=2, pool=P.Pooling.AVE)
    ...
    n.pool4 = L.Pooling(n.conv7, kernel_size=2, stride=2, pool=P.Pooling.AVE)
    ...
    n.pool5 = L.Pooling(n.conv8, kernel_size=2, stride=2, pool=P.Pooling.AVE)
    ...
    n.pool6 = L.Pooling(n.conv10, kernel_size=2, stride=2, pool=P.Pooling.AVE)
    ...
    n.pool7 = L.Pooling(n.conv11, kernel_size=2, stride=2, pool=P.Pooling.AVE)
