...
with open('elu_cnn_train.prototxt','w') as f:
    f.write(str(allcnn('../../data/mnist/mnist_train_lmdb', 64, 'mean.binaryproto')))

with open('elu_cnn_test.prototxt','w') as f:
    f.write(str(allcnn('../../data/mnist/mnist_test_lmdb', 64, 'mean.binaryproto')))
...
solver = None
solver = caffe.SGDSolver('mnist_relu_solver.prototxt')
