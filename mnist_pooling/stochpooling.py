...
stochpooling.py
Author: Adam Swart
Creates CNNs that use stochastic pooling for subsampling
'''
from pylab import *
...
def cnn_elu(lmdb, batch_size, mean):
    ...
    n.pool1 = L.Pooling(n.conv1, kernel_size=2, stride=2, pool=P.Pooling.STOCHASTIC)
    ...
    n.pool2 = L.Pooling(n.conv3, kernel_size=2, stride=2, pool=P.Pooling.STOCHASTIC)
    ...
    n.pool3 = L.Pooling(n.conv5, kernel_size=2, stride=2, pool=P.Pooling.STOCHASTIC)
    ...
    n.pool4 = L.Pooling(n.conv7, kernel_size=2, stride=2, pool=P.Pooling.STOCHASTIC)
    ...
    n.pool6 = L.Pooling(n.conv10, kernel_size=2, stride=2, pool=P.Pooling.STOCHASTIC)
    ...
    n.pool7 = L.Pooling(n.conv11, kernel_size=2, stride=2, pool=P.Pooling.STOCHASTIC)
    n.drop7 = L.Dropout(n.pool7, dropout_ratio=0.0)
    n.elu7 = L.ELU(n.drop7)

    n.pool = L.Pooling(n.elu7, global_pooling=True, pool=P.Pooling.STOCHASTIC)
...
def cnn_relu(lmdb, batch_size, mean):
    ...
    n.pool = L.Pooling(n.relu7, global_pooling=True, pool=P.Pooling.STOCHASTIC)
    n.flatten = L.Flatten(n.pool)
    n.score = L.InnerProduct(n.flatten, num_output=10, weight_filler=dict(type='gaussian'))
    n.accuracy = L.Accuracy(n.score, n.label)
    n.loss = L.SoftmaxWithLoss(n.score, n.label)
...
def cnn_leakyrelu(lmdb, batch_size, mean):
    ...
    n.pool1 = L.Pooling(n.conv1, kernel_size=2, stride=2, pool=P.Pooling.STOCHASTIC)
    n.drop1 = L.Dropout(n.pool1, dropout_ratio=0.0)
    n.relu1 = L.ReLU(n.drop1, negative_slope=0.01)
    # second stack
    n.conv2 = L.Convolution(n.relu1, kernel_size=1, num_output=192, weight_filler=dict(type='xavier'))
    n.conv3 = L.Convolution(n.conv2, kernel_size=3, num_output=240, weight_filler=dict(type='xavier'))
    n.pool2 = L.Pooling(n.conv3, kernel_size=2, stride=2, pool=P.Pooling.STOCHASTIC)
    n.drop2 = L.Dropout(n.pool2, dropout_ratio=0.1)
    n.relu2 = L.ReLU(n.drop2, negative_slope=0.01)
    # third stack
    n.conv4 = L.Convolution(n.relu2, kernel_size=1, num_output=240, weight_filler=dict(type='xavier'))
    n.conv5 = L.Convolution(n.conv4, kernel_size=2, num_output=260, weight_filler=dict(type='xavier'))
    n.pool3 = L.Pooling(n.conv5, kernel_size=2, stride=2, pool=P.Pooling.STOCHASTIC)
    n.drop3 = L.Dropout(n.pool3, dropout_ratio=0.2)
    n.relu3 = L.ReLU(n.drop3, negative_slope=0.01)
    # fourth stack
    n.conv6 = L.Convolution(n.relu3, kernel_size=1, num_output=260, weight_filler=dict(type='xavier'))
    n.conv7 = L.Convolution(n.conv6, kernel_size=2, num_output=280, weight_filler=dict(type='xavier'))
    n.pool4 = L.Pooling(n.conv7, kernel_size=2, stride=2, pool=P.Pooling.STOCHASTIC)
    n.drop4 = L.Dropout(n.pool4, dropout_ratio=0.3)
    n.relu4 = L.ReLU(n.drop4, negative_slope=0.01)
    # fifth stack
    n.conv8 = L.Convolution(n.relu4, kernel_size=1, num_output=280, weight_filler=dict(type='xavier'))
    #n.conv9 = L.Convolution(n.conv8, kernel_size=2, num_output=300, weight_filler=dict(type='xavier'))
    n.pool5 = L.Pooling(n.conv8, kernel_size=2, stride=2, pool=P.Pooling.STOCHASTIC)
    n.drop5 = L.Dropout(n.pool5, dropout_ratio=0.4)
    n.relu5 = L.ReLU(n.drop5, negative_slope=0.01)
    # sixth stack
    n.conv10 = L.Convolution(n.relu5, kernel_size=1, num_output=300, weight_filler=dict(type='xavier'))
    n.pool6 = L.Pooling(n.conv10, kernel_size=2, stride=2, pool=P.Pooling.STOCHASTIC)
    n.drop6 = L.Dropout(n.pool6, dropout_ratio=0.5)
    n.relu6 = L.ReLU(n.drop6, negative_slope=0.01)
    # seventh stack
    n.conv11 = L.Convolution(n.relu6, kernel_size=1, num_output=100, weight_filler=dict(type='xavier'))
    n.pool7 = L.Pooling(n.conv11, kernel_size=2, stride=2, pool=P.Pooling.STOCHASTIC)
    n.drop7 = L.Dropout(n.pool7, dropout_ratio=0.0)
    n.relu7 = L.ReLU(n.drop7, negative_slope=0.01)
...
def cnn_sig(lmdb, batch_size, mean):
    ...
    n.pool = L.Pooling(n.sig7, global_pooling=True, pool=P.Pooling.STOCHASTIC)
    n.flatten = L.Flatten(n.pool)
    n.score = L.InnerProduct(n.flatten, num_output=10, weight_filler=dict(type='gaussian'))
    n.accuracy = L.Accuracy(n.score, n.label)
    n.loss = L.SoftmaxWithLoss(n.score, n.label)
...
def cnn_tanh(lmdb, batch_size, mean):
    ...
    n.pool = L.Pooling(n.tanh7, global_pooling=True, pool=P.Pooling.STOCHASTIC)
    n.flatten = L.Flatten(n.pool)
    n.score = L.InnerProduct(n.flatten, num_output=10, weight_filler=dict(type='gaussian'))
    n.accuracy = L.Accuracy(n.score, n.label)
    n.loss = L.SoftmaxWithLoss(n.score, n.label)
...
def cnn_absval(lmdb, batch_size, mean):
    ...
    n.pool = L.Pooling(n.absval7, global_pooling=True, pool=P.Pooling.STOCHASTIC)
    n.flatten = L.Flatten(n.pool)
    n.score = L.InnerProduct(n.flatten, num_output=10, weight_filler=dict(type='gaussian'))
    n.accuracy = L.Accuracy(n.score, n.label)
    n.loss = L.SoftmaxWithLoss(n.score, n.label)
...
def cnn_power(lmdb, batch_size, mean):
    ...
    n.pool = L.Pooling(n.power7, global_pooling=True, pool=P.Pooling.STOCHASTIC)
    n.flatten = L.Flatten(n.pool)
    n.score = L.InnerProduct(n.flatten, num_output=10, weight_filler=dict(type='gaussian'))
    n.accuracy = L.Accuracy(n.score, n.label)
    n.loss = L.SoftmaxWithLoss(n.score, n.label)
...
def cnn_bnll(lmdb, batch_size, mean):
    ...
    n.pool = L.Pooling(n.bnll7, global_pooling=True, pool=P.Pooling.STOCHASTIC)
    n.flatten = L.Flatten(n.pool)
    n.score = L.InnerProduct(n.flatten, num_output=10, weight_filler=dict(type='gaussian'))
    n.accuracy = L.Accuracy(n.score, n.label)
    n.loss = L.SoftmaxWithLoss(n.score, n.label)
